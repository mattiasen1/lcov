///@file list.h
///@author Lukas Annsberg och Love Osslund
///@date 14 Oktober 2017
///@bug Inga kända!
///
///@brief Skapa och manipulera listor
#ifndef __list_h__
#define __list_h__
...
/// @return true if index was a valid index
...
///
/// It is undefined whether the length is calculated in O(n) time or
...
/// @brief Applies a function to all elements in a list in list order
///
/// @param list the list
